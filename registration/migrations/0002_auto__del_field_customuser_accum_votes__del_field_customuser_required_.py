...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CustomUser.accum_votes'
        db.delete_column('registration_customuser', 'accum_votes')

        # Deleting field 'CustomUser.required_votes'
        db.delete_column('registration_customuser', 'required_votes')


    def backwards(self, orm):
        
        # Adding field 'CustomUser.accum_votes'
        db.add_column('registration_customuser', 'accum_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'CustomUser.required_votes'
        db.add_column('registration_customuser', 'required_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=10), keep_default=False)
