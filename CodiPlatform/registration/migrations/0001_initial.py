...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Codi'
        db.create_table('registration_codi', (
        ...
        db.send_create_signal('registration', ['Codi'])

        # Adding model 'CustomUser'
        db.create_table('registration_customuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('codi', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['registration.Codi'], unique=True, null=True, blank=True)),
            ...
            ('accum_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('required_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=10)),
        ))
        db.send_create_signal('registration', ['CustomUser'])

        # Adding model 'Message'
        db.create_table('registration_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('registration', ['Message'])


    def backwards(self, orm):
        
        # Deleting model 'Codi'
        db.delete_table('registration_codi')

        # Deleting model 'CustomUser'
        db.delete_table('registration_customuser')

        # Deleting model 'Message'
        db.delete_table('registration_message')
