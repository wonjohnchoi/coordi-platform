# Django settings for CodiPlatform project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(basedir, 'sqlite.db'), # Or path to database file if using sqlite3.
...
SECRET_KEY = '3(_5y49^+5xr%a27_w4(7&=&=xz8pr-8ej@uqx=$^n9k19--9h'
...
ROOT_URLCONF = 'CodiPlatform.urls'
...
INSTALLED_APPS = (
    ...
    #'CodiPlatform.user',
    'CodiPlatform.general',
    'CodiPlatform.registration',
...
TEMPLATE_CONTEXT_PROCESSORS = (
   'CodiPlatform.context_processor.custom_user',
...
MEDIA_ROOT = os.path.join(basedir, 'files', 'media')
MEDIA_URL = '/media/'

STATIC_ROOT = os.path.join(basedir, 'files', 'static')
STATIC_URL = '/static/'
STATICFILES_DIRS = (
