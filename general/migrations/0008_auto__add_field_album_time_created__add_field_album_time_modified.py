...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.time_created'
        db.add_column('general_album', 'time_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 12, 25), auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Album.time_modified'
        db.add_column('general_album', 'time_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 12, 25), auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Album.time_created'
        db.delete_column('general_album', 'time_created')

        # Deleting field 'Album.time_modified'
        db.delete_column('general_album', 'time_modified')
    ...
    models = {
        ...
        'general.album': {
            ...
            'album_id': ('django.db.models.fields.CharField', [], {'default': "'18ce9c56e219194daf1eb729c99596f2'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'general.photo': {
            ...
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'5fbeda7043f8f452368a22cf659cafcd'", 'max_length': '32', 'primary_key': 'True'}),
            'position': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        'general.titlephoto': {
            'Meta': {'object_name': 'TitlePhoto'},
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'ac309c3f09b46f9790c3e112ea7cee53'", 'max_length': '32', 'primary_key': 'True'})
        },
        'registration.codi': {
