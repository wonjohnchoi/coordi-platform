...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.time_voted'
        db.add_column('general_album', 'time_voted', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 12, 27)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Album.time_voted'
        db.delete_column('general_album', 'time_voted')
    ...
    models = {
        ...
        'general.album': {
            ...
            'album_id': ('django.db.models.fields.CharField', [], {'default': "'a1477ab3466f6bc1b0b352f95f45894f'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'general.comment': {
            ...
            'comment_id': ('django.db.models.fields.CharField', [], {'default': "'02af3f96d7cbce307f8b0f6971d67bd1'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'general.photo': {
            ...
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'c1bd055be99541e204600d6cd858b5b2'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'general.post': {
            ...
            'message': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.CustomUser']"}),
            'post_id': ('django.db.models.fields.CharField', [], {'default': "'116a43d71f7a26c11a10b3708cf54ffd'", 'max_length': '32', 'primary_key': 'True'}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 12, 27)', 'auto_now_add': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 12, 27)', 'auto_now': 'True', 'blank': 'True'}),
            'unique_visit': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'})
        },
        ...
        'general.titlephoto': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'c363195b2a1f2ebee53c94ac67d900fe'", 'max_length': '32', 'primary_key': 'True'})
        },
        'general.vote': {
