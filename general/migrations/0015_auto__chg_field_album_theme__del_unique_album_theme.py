...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Album', fields ['theme']
        db.delete_unique('general_album', ['theme_id'])

        # Changing field 'Album.theme'
        db.alter_column('general_album', 'theme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['general.Theme'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Album.theme'
        db.alter_column('general_album', 'theme_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['general.Theme'], unique=True, null=True))

        # Adding unique constraint on 'Album', fields ['theme']
        db.create_unique('general_album', ['theme_id'])
    ...
    models = {
        ...
        'general.album': {
            ...
            'album_id': ('django.db.models.fields.CharField', [], {'default': "'32f4643b56a0eea20a3ff42b0138db50'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'general.comment': {
            ...
            'comment_id': ('django.db.models.fields.CharField', [], {'default': "'7d7bd4bf4ec02761830fe6da5933862d'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'general.photo': {
            ...
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'16ea6c5a794576d0399c16d34ddc42dc'", 'max_length': '32', 'primary_key': 'True'}),
        ...
        'general.post': {
            ...
            'message': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.CustomUser']"}),
            'post_id': ('django.db.models.fields.CharField', [], {'default': "'7433400d8049bd47a4652e92363d8191'", 'max_length': '32', 'primary_key': 'True'}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 12, 26)', 'auto_now_add': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 12, 26)', 'auto_now': 'True', 'blank': 'True'}),
            'unique_visit': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'})
        },
        ...
        'general.titlephoto': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'c835cf50f6b99f0b60185c07b9714fff'", 'max_length': '32', 'primary_key': 'True'})
        },
        'registration.codi': {
